...
class BadmintonPlayerAlertDialog : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Image
        imageView = findViewById(R.id.player_imageView)
        val selectedImage = intent.getIntExtra("itemClicked", 100)
        ...
        when (v?.id) {
            R.id.submit_button -> {
                ...
                if (name.isEmpty() || country.isEmpty() || year.isEmpty() || handedness.isEmpty() || coachName.isEmpty() || matches.isEmpty()) {
                    Toast.makeText(this, getString(R.string.Fields_Missing), Toast.LENGTH_LONG)
                        .show()
                    return
                }
